  ...
  return {
    ...
    statistics: {
      home: {
        ...
        tackles: getStatValue(homeStats, "Tackles"),
        interceptions: getStatValue(homeStats, "Interceptions"),
        saves: getStatValue(homeStats, "Saves"),
      },
      away: {
        ...
        tackles: getStatValue(awayStats, "Tackles"),
        interceptions: getStatValue(awayStats, "Interceptions"),
        saves: getStatValue(awayStats, "Saves"),
      },
    },

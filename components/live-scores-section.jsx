  ...
  >
    ...
    <div className="p-4 md:p-3">
      ...
      <div className="grid grid-cols-12 gap-2 md:gap-4 items-start">
        ...
        {/* Right side: League badge with country flag (3 cols) */}
        <div className="col-span-3 md:col-span-3 flex flex-col items-end gap-1.5 md:gap-2">
          ...
          <div className="text-center">
            <p className="text-[7px] md:text-[12px] text-gray-500 font-semibold uppercase">STATS</p>
            <div className="flex items-center justify-center gap-2 mt-0.5">
              <div className="text-center">
                <p className="text-[8px] md:text-[9px] text-blue-400 font-bold">{game.homeScore}</p>
                <p className="text-[6px] md:text-[7px] text-gray-500">Home</p>
              </div>
              <div className="text-center">
                <p className="text-[8px] md:text-[9px] text-cyan-400 font-bold">{game.awayScore}</p>
                <p className="text-[6px] md:text-[7px] text-gray-500">Away</p>
              </div>
            </div>
          </div>
        </div>
...
export default function LiveScoresSection() {
  ...
  const { matches: upcomingMatches, loading: upcomingLoading, error: upcomingError } = useUpcomingMatches()

  console.log("[v0] LiveScoresSection - liveMatches:", liveMatches?.length, "loading:", liveLoading)
  console.log("[v0] LiveScoresSection - upcomingMatches:", upcomingMatches?.length, "loading:", upcomingLoading)

  const liveGames = (Array.isArray(liveMatches) ? liveMatches : []).slice(0, 5)
  const upcomingGames = (Array.isArray(upcomingMatches) ? upcomingMatches : []).slice(0, 5)

            ...
            >
              ...
              {authenticated && user ? (
                <div className="relative z-[100]">
                  ...
                  >
                    <div className="h-8 w-8 rounded-full bg-gradient-to-r from-blue-500 to-cyan-500 flex items-center justify-center text-white font-semibold text-sm">
                      {user.name?.charAt(0) || "U"}
                    </div>
                    <span className="text-sm font-semibold text-gray-100">{user.name || "User"}</span>
                  </button>
                  ...
                  {profileDropdown && (
                    <div className="absolute right-0 top-full mt-2 w-48 bg-gray-800 border border-gray-700 rounded-lg shadow-2xl animate-slide-down z-[200]">
                      ...
                      <button
                        ...
                        className="w-full text-left px-4 py-3 text-red-400 hover:bg-red-950/30 text-sm font-medium transition-colors rounded-b-lg border-t border-gray-700"
                      >
                ...
                <Link href="/signin">
                  ...
                  >
                    ...
                    <UserCircle className="h-3 md:h-4 w-3 md:w-4 mr-1 md:mr-2 relative z-10 group-hover:rotate-12 transition-transform duration-300" />
                ...
                {authenticated && user ? (
                  <>
                    <Link href="/user/profile">
                      <Button className="mt-2 md:mt-3 w-full text-white shadow-lg text-xs md:text-sm bg-blue-600 hover:bg-blue-700">
                        <UserCircle className="h-3 md:h-4 w-3 md:w-4 mr-1 md:mr-2" />
                        View Profile
                      </Button>
                    </Link>
                    <Button
                      onClick={handleLogout}
                      className="mt-2 w-full bg-red-600 hover:bg-red-700 text-white shadow-lg text-xs md:text-sm"
                    >
